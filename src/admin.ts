...
adminRouter.get("/listing/update", (req, res) => {
  res.render("listingUpdate", {
    ...
    message: "Update an existing listing",
  });
});

adminRouter.get("/listing/delete", (req, res) => {
  res.render("listingDelete", {
    title: "Delete Listing",
    message: "Delete a listing",
  });
});

adminRouter.get("/listing/account-requests", (req, res) => {
  res.render("listingAccountRequests", {
    title: "Account Requests",
    message: "Manage account requests",
  });
});
...
adminRouter.get("/coupon/update", (req, res) => {
  res.render("couponUpdate", {
    title: "Update Coupon",
    message: "Update an existing coupon",
  });
});

adminRouter.get("/coupon/delete", (req, res) => {
  res.render("couponDelete", {
    title: "Delete Coupon",
